...
if (isset($_POST['save_profile'])) {
    ...
    if (empty($error)) {
        if (move_uploaded_file($_FILES['profileImage']['tmp_name'], $target_file)) {
            $doctorPro = $_SESSION['doc_id'];
            $sql = "UPDATE doctor SET image='$profileImageName' WHERE doc_id='$doctorPro' ";
...
//profile view
$doc = $_SESSION['doc_id'];
$pro = mysqli_query($conn, "SELECT * FROM doctor WHERE doc_id='$doc' ");
...
<body>
    ...
    <div class="col-lg-2 col-md-2 col-sm-3 col-xs-12">
        <nav class="w3-sidebar w3-border w3-bar-block w3-card w3-top w3-light-grey" style="width:24%">
            ...
            <a href="logout.php?logout_id=<?php echo $_SESSION['doc_id']; ?>" class=" w3-bar-item w3-button w3-border-bottom w3-hover-blue" style="text-decoration:none"><span class="glyphicon glyphicon-log-out"></span> Logout</a>
        </nav>
    </div>
            ...
            <div class="container-fluid w3-light-grey">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="logout.php?logout_id=<?php echo $_SESSION['doc_id']; ?>"><i class="fa fa-sign-out"></i> Logout</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
            <a href="doctor_profile.php"><strong><span class="fa fa-dashboard"></span> My Profile</strong></a>
            <hr>
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                                ...
                                <div class="panel-body w3-light-grey text-light">
                                    <div class="stat-panel ">
                                        ...
                                        <div class="stat-panel-title ">
                                            <form action="doctor_profile.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="panel-body text-light w3-light-grey">
                                <div class="stat-panel">
                                    ...
                                    <div class="stat-panel-title text-">
                                        ...
                                        <P><b>Name: </b><?php echo $_SESSION['firstname'];
                                                        echo " ";
                                                        echo $_SESSION['lastname']; ?></P>
                                        <p><b>Email: </b> <?php echo $_SESSION['email']; ?></P>
                                        <p><b>Title: </b><?php echo $user['healthcare_title']; ?> </p>
