...
<body>
    ...
    <div class="container contact" style="margin-left:24%">
            ...
            <div id="top-nav" class="navbar navbar-static-top" style="margin-right:10px">
                <div class="container-fluid w3-light-grey">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="view_request.php">Request </a>
                    </div>
        ...
        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
            <a href="view_request.php"><strong><span class="fa fa-dashboard"></span> Available Request</strong></a>
            <hr>
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                    ...
                                    <div class="stat-panel text-center">
                                        ...
                                        <div class="stat-panel-title text-uppercase">Available Request </div>
                    ...
                    <tr>
                       ...
                       <!-- <th>Patient Name</th> 
                        ...
                        <?php 
                            ...
                            $view_request  = mysqli_query($conn, "SELECT * FROM  request WHERE request_status='Pending' ");

                            if(mysqli_num_rows($view_request) > 0){

                                while($row=mysqli_fetch_array($view_request)){
                                        echo "<tr>" ;
                            ...
                            echo "<tr>" ;
                            echo "<td class='text-center text-danger' colspan='11' > No available request  </td>";
                            echo "</tr>" ;
                            }
                        ?>
                    </table>
