...
<body>
    ...
    <div class="col-lg-2 col-md-2 col-sm-3 col-xs-12">
        <nav class="w3-sidebar w3-border w3-bar-block w3-card w3-top w3-light-grey" style="width:24%">
            ...
            <div class="w3-dropdown-hover">
                ...
                <div class="w3-dropdown-content w3-bar-block">
                    <a href=" .php" class="w3-bar-item w3-button w3-border-bottom w3-hover-blue" style="text-decoration:none">View Patients</a>
    ...
    <div class="container contact" style="margin-left:24%">
        ...
        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-12">
            <a href="admin.php"><strong><span class="fa fa-dashboard"></span> Available Doctors</strong></a>
            <hr>
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                    ...
                                    <div class="stat-panel text-center">
                                        ...
                                        <div class="stat-panel-title text-uppercase">Available Doctors </div>
                        ...
                        $doctors = mysqli_query($conn, "SELECT * FROM doctor ");
                            ...
                            if(mysqli_num_rows($doctors) > 0 ){
                                while($doc_row=mysqli_fetch_array($doctors)){
                                    ...
                                    // echo "<td>" . $doc_row['description']. "</td>";
                                ...
                                echo "<tr>" ;
                                echo "<td class='text-center text-danger' colspan='11' > No available patients  </td>";
                                echo "</tr>" ;
                                }
                        ?>
                    </table>
